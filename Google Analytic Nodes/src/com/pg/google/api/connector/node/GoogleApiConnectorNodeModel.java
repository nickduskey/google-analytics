 ...
 * 
 */
public class GoogleApiConnectorNodeModel extends NodeModel {

    private GoogleApiConnectorNodeConfiguration m_config = new GoogleApiConnectorNodeConfiguration();

    /**
     * Constructor of the node model.
     */
    protected GoogleApiConnectorNodeModel() {
