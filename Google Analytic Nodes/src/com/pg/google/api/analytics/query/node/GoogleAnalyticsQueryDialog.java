...
public class GoogleAnalyticsQueryDialog extends NodeDialogPane {
    ...
    private static final NodeLogger LOGGER = NodeLogger.getLogger(GoogleAnalyticsQueryDialog.class);
    ...
    protected void loadSettingsFrom(NodeSettingsRO settings, PortObjectSpec[] specs) throws NotConfigurableException {
        ...
        try {
            ...
            if (spec != null) {
                ...
                if ( m_segments == null ) {
                	LOGGER.info("Getting Profile Segments...");
                	m_segments = connection.getAnalytics().management().segments().list().execute();
                }    
            	for (Segment seg : m_segments.getItems()) {
                ...
                if (m_columns == null || !m_columns.getEtag().equals(getEtag(connection))) {
                    LOGGER.info("Getting Google Analytics dimensions and measures");
